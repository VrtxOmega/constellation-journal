...
* **100% Local Sovereignty:** Your thoughts belong to you. Powered entirely by local SQLite and offline LLMs. Nothing leaves your machine. 
...
2. `npm install`
3. `npm start` (requires Ollama running locally for semantic features)
